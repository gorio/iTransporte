...
/**
 * A categoria Previsão de chegada é a responsável por retornar a previsão de chegada de cada
 * veículo de uma determinada linha e de um determinado ponto de parada, além da localização exata
 * de cada veículo que constar na cadeia de previsões.
